...
const PricingCards = () => (
  <div className="bg-amber-100 box-border">
    <div className="box-border max-w-[1440px] m-auto pb-6">
      <div className="box-border hidden max-w-[1200px] w-full m-auto md:block">
        <div className="items-end box-border flex flex-wrap -mx-3 py-6">
          <PricingCard
            ...
            bottleImageSrc="https://c.animaapp.com/mnsem251Wpf2gA/assets/emma-bottle-1.webp"
          ...
          <PricingCard
            ...
            bottleImageSrc="https://c.animaapp.com/mnsem251Wpf2gA/assets/emma-bottle-6.webp"
          ...
          <PricingCard
            ...
            bottleImageSrc="https://c.animaapp.com/mnsem251Wpf2gA/assets/emma-bottle-3.webp"
      ...
      <MobilePricingCards
        headerImageSrc="https://c.animaapp.com/mnsem251Wpf2gA/assets/Header.webp"
        bottleSixImageSrc="https://c.animaapp.com/mnsem251Wpf2gA/assets/emma-bottle-6.webp"
        bottleThreeImageSrc="https://c.animaapp.com/mnsem251Wpf2gA/assets/emma-bottle-3.webp"
        bottleOneImageSrc="https://c.animaapp.com/mnsem251Wpf2gA/assets/emma-bottle-1.webp"
        checkImageSrc="https://c.animaapp.com/mnsem251Wpf2gA/assets/check-Copy.webp"
        ctaImageSrc="https://c.animaapp.com/mnsem251Wpf2gA/assets/CTA.webp"
        paymentMethodImageSrc="https://c.animaapp.com/mnsem251Wpf2gA/assets/paymentmethod.webp"
