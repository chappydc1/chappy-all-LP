  ...
  <div className="bg-amber-100 box-border">
    <div className="box-border max-w-[1440px] m-auto pb-6">
      <div className="box-border hidden max-w-[1200px] w-full m-auto md:block">
        <div className="items-end box-border flex flex-wrap -mx-3 py-6">
          <EmmaPricingCard
            ...
            bottleImageSrc="/lp-images-files-videos-fonts/images/emma/emma-bottle-1.webp"
          ...
          <EmmaPricingCard
            ...
            bottleImageSrc="/lp-images-files-videos-fonts/images/emma/emma-bottle-6.webp"
          ...
          <EmmaPricingCard
            ...
            bottleImageSrc="/lp-images-files-videos-fonts/images/emma/emma-bottle-3.webp"
      ...
      <EmmaMobilePricingCards
        headerImageSrc="/lp-images-files-videos-fonts/images/emma/Header.webp"
        bottleSixImageSrc="/lp-images-files-videos-fonts/images/emma/emma-bottle-6.webp"
        bottleThreeImageSrc="/lp-images-files-videos-fonts/images/emma/emma-bottle-3.webp"
        bottleOneImageSrc="/lp-images-files-videos-fonts/images/emma/emma-bottle-1.webp"
        checkImageSrc="/lp-images-files-videos-fonts/images/emma/check-Copy.webp"
        ctaImageSrc="/lp-images-files-videos-fonts/images/emma/CTA.webp"
        paymentMethodImageSrc="/lp-images-files-videos-fonts/images/emma/paymentmethod.webp"
