import { TodayPricingCard } from "./TodayPricingCard";
      ...
      <div className="items-center box-border caret-transparent flex flex-col justify-center max-w-[1210px] outline-[3px] text-center w-[95%] mx-auto md:max-w-screen-xl">
        <ul className="items-end box-border caret-transparent gap-x-8 grid grid-cols-[repeat(1,1fr)] outline-[3px] gap-y-8 w-full mb-6 pl-0 md:grid-cols-[repeat(3,1fr)] md:mb-[68px]">
          <TodayPricingCard
            ...
            imageSrc="/lp-images-files-videos-fonts/images/today/2_BOTTLES.png"
            imageAlt="2 Bottles"
            showFreeIcon="false"
            freeIconSrc=""
            freeIconAlt=""
            ...
            buttonImageSrc="/lp-images-files-videos-fonts/images/today/button.webp"
            buttonImageAlt="Add To Cart"
            showCursorImage="false"
            cursorImageSrc=""
            cursorImageAlt=""
            cardImageSrc="/lp-images-files-videos-fonts/images/today/card.png"
          ...
          <TodayPricingCard
            ...
            imageSrc="/lp-images-files-videos-fonts/images/today/6_BOTTLES.png"
            imageAlt="6 Bottles"
            showFreeIcon="true"
            freeIconSrc="/lp-images-files-videos-fonts/images/today/free.svg"
            freeIconAlt=""
            ...
            cursorImageSrc="/lp-images-files-videos-fonts/images/today/cursor.png"
            cursorImageAlt=""
            cardImageSrc="/lp-images-files-videos-fonts/images/today/card.png"
            cardImageAlt="Credit Cards"
            totalTextClass=""
          ...
          <TodayPricingCard
            ...
            imageWrapperClass="overflow-visible md:overflow-hidden before:accent-auto before:bg-[linear-gradient(190deg,rgb(19,97,153)_0.64%,rgb(22,121,218)_41.87%,rgb(19,97,153)_99.99%)] before:box-border before:caret-transparent before:text-black before:block before:text-base before:not-italic before:normal-nums before:font-normal before:h-[120px] before:tracking-[normal] before:leading-6 before:list-outside before:list-none before:outline-[3px] before:pointer-events-auto before:absolute before:text-center before:no-underline before:indent-[0px] before:normal-case before:visible before:w-[120px] before:z-[1] before:rounded-[50%] before:border-separate before:left-2/4 before:top-0 before:font-montserrat before:md:h-60 before:md:w-60"
            imageSrc="/lp-images-files-videos-fonts/images/today/3_BOTTLES.png"
            imageAlt="3 Bottles"
            showFreeIcon="true"
            freeIconSrc="/lp-images-files-videos-fonts/images/today/free.svg"
            freeIconAlt=""
        ...
        <img
          src="/lp-images-files-videos-fonts/images/today/medalhas.png"
          alt=""
