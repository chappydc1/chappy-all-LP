  ...
  return (
    <div className="box-border caret-transparent outline-[3px]">
      <GetokinawatonicTestimonialCard
        ...
        imageUrl="/lp-images-files-videos-fonts/images/getokinawatonic/courtney.jpg"
        imageAlt="img"
        name="Courtney"
        ratingClassName=""
      />
      <GetokinawatonicTestimonialCard
        ...
        imageUrl="/lp-images-files-videos-fonts/images/getokinawatonic/john.jpg"
        imageAlt="img"
        name="John"
        ratingClassName=""
      />
      <GetokinawatonicTestimonialCard
        ...
        imageUrl="/lp-images-files-videos-fonts/images/getokinawatonic/rina.jpg"
        imageAlt="img"
        name="Rina"
        ratingClassName=""
      />
