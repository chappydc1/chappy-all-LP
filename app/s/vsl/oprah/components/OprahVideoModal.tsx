    ...
    >
      ...
      >
        <div className="box-border">
          <h1 className="text-zinc-500 text-lg box-border h-[60px] leading-[60px] text-center overflow-hidden mb-2 pt-4 font-helvetica" />
          <button
            onClick={() => setIsOpen(false)}
