  ...
  <div className="bg-[#fff4bf] box-border border-y border-[#eadf9d]">
    <div className="box-border max-w-[1360px] m-auto px-4 py-10 md:py-16">
      <div className="box-border hidden max-w-[1180px] w-full m-auto md:block">
        <div className="items-end box-border flex flex-wrap justify-center -mx-3 py-6">
          <OprahPricingCard
            ...
            bottleImageSrc="/lp-images-files-videos-fonts/images/oprah/emma-bottle-1.webp"
          ...
          <OprahPricingCard
            ...
            bottleImageSrc="/lp-images-files-videos-fonts/images/oprah/emma-bottle-6.webp"
          ...
          <OprahPricingCard
            ...
            bottleImageSrc="/lp-images-files-videos-fonts/images/oprah/emma-bottle-3.webp"
      ...
      <OprahMobilePricingCards
        headerImageSrc="/lp-images-files-videos-fonts/images/oprah/Header.webp"
        bottleSixImageSrc="/lp-images-files-videos-fonts/images/oprah/emma-bottle-6.webp"
        bottleThreeImageSrc="/lp-images-files-videos-fonts/images/oprah/emma-bottle-3.webp"
        bottleOneImageSrc="/lp-images-files-videos-fonts/images/oprah/emma-bottle-1.webp"
        checkImageSrc="/lp-images-files-videos-fonts/images/oprah/check-Copy.webp"
        ctaImageSrc="/lp-images-files-videos-fonts/images/oprah/CTA.webp"
        paymentMethodImageSrc="/lp-images-files-videos-fonts/images/oprah/paymentmethod.webp"
