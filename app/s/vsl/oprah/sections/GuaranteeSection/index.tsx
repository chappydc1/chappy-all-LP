    ...
    <div className="bg-stone-100 box-border">
      <div className="box-border max-w-[1440px] m-auto pt-40 pb-12 px-2 md:px-0">
        <div className="bg-white box-border max-w-[830px] w-full m-auto border-8 border-solid border-slate-200 reveal-scale">
          <img
            src="/lp-images-files-videos-fonts/images/oprah/guaranteed.webp"
        ...
        <div className="box-border max-w-[870px] w-full mt-12 mb-auto mx-auto reveal">
          <div
            className="bg-emerald-800 box-border py-6 rounded-t-[5px]"
            style={{ background: "linear-gradient(rgb(0,0,0), rgba(0, 100, 80, 0.9))" }}
          >
          ...
          <div className="box-border flex flex-wrap mt-12 -mx-3">
            {[
              ...
              <div key={t.name} className="box-border shrink-0 max-w-full w-full px-3 md:w-6/12 reveal-left" style={{ transitionDelay: `${i * 0.15}s` }}>
                <div className="box-border">
                  <img src={`/media/${t.img}.webp`} className="box-border inline" alt={t.name} />
                  <div className="box-border inline-block align-middle">
                    ...
                    <img src="/lp-images-files-videos-fonts/images/oprah/check-mark.webp" className="box-border inline w-[17px]" alt="Verified" />
                  </div>
                  <img src="/lp-images-files-videos-fonts/images/oprah/storystars.webp" className="box-border float-right pt-6" alt="5 star rating" />
                </div>
                <div className="bg-white box-border mt-1 p-6 rounded-b-sm">
                  ...
                  <span className="text-black box-border block pt-2 font-myriad_pro" dangerouslySetInnerHTML={{ __html: t.text }} />
                </div>
              </div>
            ))}
            {[
