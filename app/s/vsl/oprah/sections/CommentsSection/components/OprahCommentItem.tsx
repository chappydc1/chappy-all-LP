      ...
      <p className={`box-border caret-transparent mb-[14.4px] flex items-center gap-1 flex-wrap ${textClass ?? ""}`}>
        ...
        >
          <img
            role="img"
            alt="👍"
            src="/lp-images-files-videos-fonts/images/oprah/1f44d.svg"
        ...
        <span className="reply-btn font-inherit text-inherit">
          <img
            role="img"
            alt="🔁"
            src="/lp-images-files-videos-fonts/images/oprah/1f501.svg"
            className="box-border caret-transparent inline max-w-full h-3.5 w-3.5 mx-[0.98px]"
          />
          {` Reply – ${actionText}`}
        </span>
...
export const OprahCommentItem = (props: OprahCommentItemProps) => {
  ...
  return (
    <div
      ref={ref}
      className={`scroll-reveal relative content-start bg-white box-border caret-transparent gap-x-5 grid grid-cols-[repeat(1,1fr)] grid-rows-[repeat(1,1fr)] justify-start min-h-[auto] gap-y-5 w-full pt-[25px] px-0 md:px-[55px] ${props.outerClass ?? "md:pt-[30px]"}`}
    >
