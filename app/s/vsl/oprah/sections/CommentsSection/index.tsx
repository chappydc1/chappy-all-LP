  ...
  return (
    ...
    >
      <div className="items-stretch box-border caret-transparent gap-x-px flex flex-col grow flex-wrap h-full max-w-[min(100%,767px)] min-h-[auto] min-w-[auto] gap-y-px w-full mx-auto pt-2.5 pb-[60px] md:flex-nowrap md:max-w-[972px] md:pt-[25px] md:pb-[50px]">
        <OprahCommentHeader />
        <OprahCommentItem
          avatarSrc="/lp-images-files-videos-fonts/images/oprah/hEMtnu2001596.webp"
          name="Sarah Smith"
        ...
        <OprahReplyItem
          ...
          avatarSrc="/lp-images-files-videos-fonts/images/oprah/kbPeho2025190.webp"
        ...
        />
        <OprahCommentItem
          avatarSrc="/lp-images-files-videos-fonts/images/oprah/aAtbjA2058308.webp"
          name="Olivia Moore"
          ...
          replies={[
            {
              avatarSrc: "/lp-images-files-videos-fonts/images/oprah/cIxqDb2133076.webp",
              name: "Emily Johnson",
        ...
        />
        <OprahCommentItem
          avatarSrc="/lp-images-files-videos-fonts/images/oprah/IeAIgy2205219.webp"
        ...
        />
        <OprahCommentItem
          avatarSrc="/lp-images-files-videos-fonts/images/oprah/KtysvY2314645.webp"
        ...
        <OprahReplyItem
          variant="comment"
          variantClass="gap-x-px gap-y-px ml-[65px] md:ml-[100px]"
          avatarSrc="/lp-images-files-videos-fonts/images/oprah/JSKEQM2241629.webp"
        ...
        />
        <OprahCommentItem
          avatarSrc="/lp-images-files-videos-fonts/images/oprah/pberKS2391370.webp"
          name="Jessica Brown"
          ...
          replies={[
            {
              avatarSrc: "/lp-images-files-videos-fonts/images/oprah/FEksgJ2345870.webp",
              name: "Chloe Garcia",
