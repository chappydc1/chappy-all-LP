export const GlycoflushMobileNavMenu = () => {
  return (
    <div className="relative box-border caret-transparent gap-x-5 block max-w-full min-h-[auto] outline-[3px] gap-y-5 w-[16%] md:hidden md:min-h-0 md:w-[34%]">
      <div className="box-border caret-transparent outline-[3px] text-start md:text-end">
        <div className="text-white text-xl box-border caret-transparent inline-block leading-5 outline-[3px] text-center">
          <img
            src="/lp-images-files-videos-fonts/images/glycoflush/icon-2.svg"
            alt="Icon"
