  ...
  return (
    <div className="relative bg-white box-border caret-transparent gap-x-0 flex flex-col flex-wrap min-h-[auto] outline-[3px] gap-y-0 w-full border border-stone-300 p-2.5 rounded-[20px] border-solid md:flex-nowrap">
      <GlycoflushCommentItem
        avatarSrc="/lp-images-files-videos-fonts/images/glycoflush/Screenshot_9-1.png"
        avatarAlt=""
        ...
        reactionSrc="/lp-images-files-videos-fonts/images/glycoflush/@fbreaction.webp"
        reactionAlt=""
      ...
      />
      <GlycoflushCommentItem
        avatarSrc="/lp-images-files-videos-fonts/images/glycoflush/Screenshot_10-1.png"
        avatarAlt=""
      ...
      />
      <GlycoflushCommentItem
        avatarSrc="/lp-images-files-videos-fonts/images/glycoflush/Screenshot_11-1.png"
        avatarAlt=""
      ...
      />
      <GlycoflushCommentItem
        avatarSrc="/lp-images-files-videos-fonts/images/glycoflush/Screenshot_12-1.png"
        avatarAlt=""
      ...
      />
      <GlycoflushCommentItem
        avatarSrc="/lp-images-files-videos-fonts/images/glycoflush/prtdepo01-3-1.webp"
        avatarAlt=""
      ...
      />
      <GlycoflushCommentItem
        avatarSrc="/lp-images-files-videos-fonts/images/glycoflush/Screenshot_14-1.png"
        avatarAlt=""
