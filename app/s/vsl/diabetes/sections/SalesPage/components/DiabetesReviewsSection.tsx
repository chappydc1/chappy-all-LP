import { DiabetesReviewCard } from "./DiabetesReviewCard";
      ...
      <div className="box-border caret-transparent max-w-[1000px] outline-[3px] w-full mx-auto px-3">
        ...
        <div className="bg-neutral-100 box-border caret-transparent outline-[3px]">
          <DiabetesReviewCard
            ...
            avatarSrc="/lp-images-files-videos-fonts/images/img/avatar.webp?hopId=5f160ca7-bd6b-4c23-b55d-9b6214111f05"
            avatarAlt="Profile"
            reviewerName="Linda M."
            reviewerLocation="Montclair, NJ"
            title="Glycocept saved my life"
            imageSrc="/lp-images-files-videos-fonts/images/img/depoimento/1f.jpg?hopId=5f160ca7-bd6b-4c23-b55d-9b6214111f05"
            imageAlt=""
          ...
          <DiabetesReviewCard
            ...
            imageSrc="/lp-images-files-videos-fonts/images/img/depoimento/102.jpg?hopId=5f160ca7-bd6b-4c23-b55d-9b6214111f05"
            imageAlt=""
          ...
          <DiabetesReviewCard
            ...
            imageSrc="/lp-images-files-videos-fonts/images/img/depoimento/4f.jpg?hopId=5f160ca7-bd6b-4c23-b55d-9b6214111f05"
            imageAlt=""
          ...
          <DiabetesReviewCard
            ...
            imageSrc="/lp-images-files-videos-fonts/images/img/depoimento/5f.jpg?hopId=5f160ca7-bd6b-4c23-b55d-9b6214111f05"
            imageAlt=""
