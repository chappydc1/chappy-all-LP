    ...
    <div className="items-stretch bg-neutral-100 box-border caret-transparent flex flex-wrap justify-start max-w-full outline-[3px] md:flex-nowrap">
      <div className="relative items-center bg-white box-border caret-transparent block basis-px grow justify-center max-w-[1400px] min-h-[25px] outline-[3px] w-min m-auto px-0 py-5 md:flex md:px-[100px] md:py-[50px]">
        ...
        <div className="box-border caret-transparent min-h-0 min-w-0 outline-[3px] w-full px-[15px] py-3 md:min-h-[auto] md:min-w-[auto] md:px-2.5">
          ...
          <RejuvacareKitItem
            rootVariant="mt-5"
            imageSrc="/lp-images-files-videos-fonts/images/rejuvacare/1722826373249_num_circle_1.webp"
          ...
          <RejuvacareKitItem
            rootVariant="mt-2.5"
            imageSrc="/lp-images-files-videos-fonts/images/rejuvacare/1722826366022_num_circle_2.webp"
          ...
          <RejuvacareKitItem
            rootVariant="mt-2.5"
            imageSrc="/lp-images-files-videos-fonts/images/rejuvacare/1722826593777_num_circle_3.webp"
          ...
          <RejuvacareKitItem
            rootVariant="mt-2.5"
            imageSrc="/lp-images-files-videos-fonts/images/rejuvacare/1722833788239_num_circle_4.webp"
