...
<img title="" src="https://c.animaapp.com/mpy7eadgYZFUdm/assets/1722832035148_5_stars_yellow.png" alt="" className="text-black box-border caret-transparent max-w-full min-h-[auto] min-w-[auto] outline-[3px] w-[110px] my-2.5 md:w-[150px] md:mb-[30px]" />
<div className="items-start box-border caret-transparent flex flex-col justify-center min-h-[auto] min-w-[auto] outline-[3px] w-full md:flex-row"><TestimonialCard
  ...
  imageUrl="https://c.animaapp.com/mpy7eadgYZFUdm/assets/1722832434914_silvia_m.webp"
  ...
  authorName="Silvia M."
  ratingImageUrl="https://c.animaapp.com/mpy7eadgYZFUdm/assets/1722832035148_5_stars_yellow.png"
/><TestimonialCard
  cardVariant="shadow-[rgba(0,0,0,0.1)_2px_2px_8px_2px]"
  imageUrl="https://c.animaapp.com/mpy7eadgYZFUdm/assets/1722832418378_bridget_f.webp"
