...
type ArticleSectionEntry =
  ...
  | { type: "video"; srcKey?: "secondVideoSrc" | "thirdVideoSrc" | "fourthVideoSrc" | "fifthVideoSrc" | "sixthVideoSrc" | "seventhVideoSrc" | "eighthVideoSrc" }
            ...
            <ul key={i} className="text-zinc-800 text-[17px] bg-[rgb(226,244,249)] leading-[25.5px] list-none text-left mb-2.5 px-[15px] py-0.5 font-open_sans">
              {section.items.map((item) => (
                <li key={item} className="p-[5px]">
                  <div className="items-center flex p-[5px]">
                    {section.variant === "negative" ? (
                      <svg viewBox="0 0 14 20" width="14" height="20" className="mr-2.5 flex-shrink-0">
                        <g stroke="rgb(255,0,0)" strokeWidth="2.4" strokeLinecap="round">
                          <line x1="2.5" y1="5" x2="11.5" y2="15" />
                          <line x1="11.5" y1="5" x2="2.5" y2="15" />
                        </g>
                      </svg>
                    ) : (
