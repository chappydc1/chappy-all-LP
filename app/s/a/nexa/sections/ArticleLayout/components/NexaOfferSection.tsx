  ...
  if (props.variant === "offerDetails") {
    return (
      <div className="box-border caret-transparent outline-[3px] text-left mt-[15px]">
        ...
        <img
          title=""
          src="/lp-images-files-videos-fonts/images/nexa/1729171287293_1718042058_1711466088389_2_min.gif"
          {...({ href: "" } as { href: string })}
          alt=""
        ...
        <div className="box-border caret-transparent outline-[3px] bg-orange-100 hidden justify-between w-full pt-5 pb-3 px-2.5 md:flex">
          ...
          <img
            title=""
            src="/lp-images-files-videos-fonts/images/nexa/1765200385645_8.png"
            {...({ href: "" } as { href: string })}
            alt=""
  ...
  if (props.variant === "badges") {
    return (
      <div className="box-border caret-transparent outline-[3px] bg-yellow-100 flex justify-between w-full pt-5 pb-[15px] px-2.5 md:pb-5 md:px-[60px]">
        <img
          title=""
          src="/lp-images-files-videos-fonts/images/nexa/1729170908849_1713302159_1711974144_90_day.webp"
          {...({ href: "" } as { href: string })}
          alt=""
        ...
        <img
          title=""
          src="/lp-images-files-videos-fonts/images/nexa/1729170970741_1713302401_1711974157_shipping.webp"
          {...({ href: "" } as { href: string })}
          alt=""
          className="text-black box-border caret-transparent h-[65px] max-w-full min-h-[auto] min-w-[auto] outline-[3px] align-baseline w-[65px] md:h-[120px] md:w-[120px]"
        />
        <img
          title=""
          src="/lp-images-files-videos-fonts/images/nexa/1729170972423_1713302404_1711974169_secure_checkout.webp"
          {...({ href: "" } as { href: string })}
          alt=""
          className="text-black box-border caret-transparent h-[65px] max-w-full min-h-[auto] min-w-[auto] outline-[3px] align-baseline w-[65px] md:h-[120px] md:w-[120px]"
        />
        <img
          title=""
          src="/lp-images-files-videos-fonts/images/nexa/1729170974121_1713302409_1711974180_easy_returns.webp"
          {...({ href: "" } as { href: string })}
          alt=""
          className="text-black box-border caret-transparent h-[65px] max-w-full min-h-[auto] min-w-[auto] outline-[3px] align-baseline w-[65px] md:h-[120px] md:w-[120px]"
        />
