...
export const TodayCommentItem = (props: TodayCommentItemProps) => {
  ...
  return (
    ...
    >
      <div className="text-white text-sm font-bold bg-sky-950 shadow-[rgba(0,0,0,0.05)_0px_1px_2px_0px] box-border caret-transparent flex h-11 min-h-[auto] min-w-[auto] items-center justify-center outline-[3px] w-11 rounded-sm">
        {initials}
      </div>
