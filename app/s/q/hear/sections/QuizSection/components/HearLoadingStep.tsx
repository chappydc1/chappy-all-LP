        ...
        <div className="box-border caret-transparent outline-[3px]">
          <span className="box-border caret-transparent outline-[3px]">
            <div className="box-border caret-transparent outline-[3px] text-center pt-[25px] md:pt-[35px]">
              <div className="bg-[url('/lp-images-files-videos-fonts/images/hear/loader-hearcom-logo.svg')] bg-no-repeat bg-contain box-border caret-transparent h-[52px] outline-[3px] w-[140px] mb-[35px] mx-auto"></div>
