import { PrimepicksFeaturedProductCard } from "./PrimepicksFeaturedProductCard";
import { PrimepicksProductCard } from "./PrimepicksProductCard";
    ...
    <div className="box-border caret-transparent max-w-[1000px] mx-auto px-4 md:px-0">
      <div className="relative box-border caret-transparent">
        ...
        <PrimepicksProductCard
          ...
          title="2. Tile Pro"
          brandName="Target"
          imageUrl="/lp-images-files-videos-fonts/images/primepicks/Ml8uanBn.jpg"
          reviewScore="8.6"
          ratingImageUrl="/lp-images-files-videos-fonts/images/primepicks/TrustRate-4-half-stars-1-1-1-2-2-2.svg"
        ...
        <PrimepicksProductCard
          ...
          brandName="Eufy"
          imageUrl="/lp-images-files-videos-fonts/images/primepicks/M18uanBn.jpg"
          reviewScore="8.2"
          ratingImageUrl="/lp-images-files-videos-fonts/images/primepicks/product-3-rating-2.svg"
        ...
        <PrimepicksProductCard
          ...
          brandName="pebblebee"
          imageUrl="/lp-images-files-videos-fonts/images/primepicks/NF8uanBn.jpg"
          reviewScore="7.1"
          ratingImageUrl="/lp-images-files-videos-fonts/images/primepicks/product-4-rating-2.svg"
        ...
        <PrimepicksProductCard
          ...
          brandName="NOMAD"
          imageUrl="/lp-images-files-videos-fonts/images/primepicks/NV8uanBn.jpg"
          reviewScore="6.3"
          ratingImageUrl="/lp-images-files-videos-fonts/images/primepicks/product-5-rating-2.svg"
      ...
      <div className="relative box-border caret-transparent text-center mt-5 after:accent-auto after:bg-stone-300 after:box-border after:caret-transparent after:text-black after:block after:text-base after:not-italic after:normal-nums after:font-normal after:h-px after:tracking-[normal] after:leading-6 after:list-outside after:list-disc after:pointer-events-auto after:absolute after:text-center after:no-underline after:indent-[0px] after:normal-case after:visible after:w-full after:-mt-0.5 after:border-separate after:left-0 after:top-2/4 after:font-open_sans">
        <button className="appearance-none bg-transparent caret-transparent w-full mx-auto p-0">
          <i className="relative text-stone-300 italic bg-stone-50 box-border caret-transparent block h-12 leading-[44px] w-12 z-[100] border border-stone-300 mx-auto rounded-[50%] border-solid">
            <img
              src="/lp-images-files-videos-fonts/images/primepicks/icon-2.svg"
              alt="Icon"
