    ...
    <div className="box-border caret-transparent max-w-[1000px] mx-auto px-4 md:px-0">
      <div className="relative box-border caret-transparent">
        ...
        <ProductCard
          ...
          title="2. Tile Pro"
          brandName="Target"
          imageUrl="/assets/primepicks/Ml8uanBn.jpg"
          reviewScore="8.6"
          ratingImageUrl="/assets/primepicks/TrustRate-4-half-stars-1-1-1-2-2-2.svg"
        ...
        <ProductCard
          ...
          brandName="Eufy"
          imageUrl="/assets/primepicks/M18uanBn.jpg"
          reviewScore="8.2"
          ratingImageUrl="/assets/primepicks/product-3-rating-2.svg"
        ...
        <ProductCard
          ...
          brandName="pebblebee"
          imageUrl="/assets/primepicks/NF8uanBn.jpg"
          reviewScore="7.1"
          ratingImageUrl="/assets/primepicks/product-4-rating-2.svg"
        ...
        <ProductCard
          ...
          brandName="NOMAD"
          imageUrl="/assets/primepicks/NV8uanBn.jpg"
          reviewScore="6.3"
          ratingImageUrl="/assets/primepicks/product-5-rating-2.svg"
