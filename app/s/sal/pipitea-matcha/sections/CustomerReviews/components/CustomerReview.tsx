              ...
              >
                ...
                >
                  <img
                    ...
                    href=""
                    title=""
                    className="box-border caret-transparent h-full max-w-full min-h-[auto] min-w-[auto] outline-[3px] w-full rounded-t-xl"
                  />
                </div>
              </div>
              <div
                  ...
                  >
                    ...
                    >
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <div
                                  href=""
                                  className={`text-[16.9583px] box-border caret-transparent leading-[25.4375px] min-h-[auto] min-w-[auto] outline-[3px] text-left w-full mr-[5px] ${props.secondReviewerNameClassName}`}
                                >
                                  <div
                                    href=""
                                    className={`text-[16.9583px] box-border caret-transparent leading-[25.4375px] outline-[3px] w-full ${props.secondReviewerNameClassName}`}
                                  >
                                    <p
                                      href=""
                                      className={`text-[16.9583px] box-border caret-transparent leading-[25.4375px] outline-[3px] ${props.secondReviewerNameClassName}`}
                                    >
                                      <strong
                                        href=""
                                        className={`text-[16.9583px] font-bold box-border caret-transparent leading-[25.4375px] outline-[3px] ${props.secondReviewerNameClassName}`}
                                      >
                                        {props.secondReviewerName}
                                      </strong>
                                    </p>
                                  </div>
                                </div>
                      ...
                      >
                        <div
                          href=""
                          className={`box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px] text-left w-full mt-[15px] md:text-base md:leading-6 ${props.secondReviewerTextClassName}`}
                        >
                          <div
                            href=""
                            className={`box-border caret-transparent outline-[3px] w-full md:text-base md:leading-6 ${props.secondReviewerTextClassName}`}
                          >
                            <p
                              href=""
                              className={`box-border caret-transparent outline-[3px] md:text-base md:leading-6 ${props.secondReviewerTextClassName}`}
                            >
                              {props.secondReviewText}
                            </p>
                          </div>
                        </div>
                      </div>
