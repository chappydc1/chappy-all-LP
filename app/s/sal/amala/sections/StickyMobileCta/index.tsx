...
export const StickyMobileCta = () => {
  return (
    <Media at="sm">
      <section
        className="items-center bg-white bg-no-repeat box-border caret-transparent flex flex-col justify-items-center min-h-[auto] min-w-[auto] outline-[3px] w-full fixed bottom-0 left-0 right-0 z-10 border-neutral-400/50 bg-center px-[15px] py-[9px] border-t md:min-h-0 md:min-w-0"
      >
      <div
