import { PromiseItem } from "../PromiseSection/components/PromiseItem";

export type PromiseSectionItem = {
  imageSrc: string;
  text: string;
  alt: string;
  title: string;
...
export type PromiseSectionProps = {
  ...
  showTopIcons: string;
  desktopItems: PromiseSectionItem[];
  mobileItems: PromiseSectionItem[];
};

export const PromiseSection = (props: PromiseSectionProps) => {
  return (
    <section
