import { AmalaTestimonialCard } from "../AmalaTestimonialsSection/components/AmalaTestimonialCard";
import { AmalaCtaBanner } from "../../components/AmalaCtaBanner";

export type AmalaTestimonialsSectionProps = {
...
export const AmalaTestimonialsSection = (props: AmalaTestimonialsSectionProps) => {
          ...
          <div className="box-border caret-transparent flex flex-col outline-[3px] w-full">
            {desktopRows.map((row, rowIndex) => (
              <div
                ...
                className={`items-stretch box-border caret-transparent hidden flex-col flex-wrap justify-start outline-[3px] md:flex md:flex-row md:flex-nowrap ${
                  rowIndex === 0
            ...
            {mobileRows.map((row, rowIndex) => (
              <div
                ...
                className={`items-stretch box-border caret-transparent flex flex-wrap justify-start outline-[3px] md:hidden md:flex-nowrap ${
                  rowIndex === 0
                    ? "mt-0 p-px md:pt-2.5 md:px-2.5"
