    ...
    >
      ...
      >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <img
                      src="/lp-images-files-videos-fonts/images/amala/1763702956506_1730181221_checkIcon.svg"
                      alt=""
                      title=""
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <div className="text-[16.0583px] box-border caret-transparent leading-[24.0875px] outline-[3px] md:text-lg md:leading-[27px]">
                        <span className="text-[16.0583px] font-bold box-border caret-transparent leading-[24.0875px] outline-[3px] md:text-lg md:leading-[27px]">
                          30 High-Concentration Hydrogen Tablets
                        </span>
                      </div>
                    </div>
                  </div>
        ...
        >
          ...
          >
            <div
              className="items-start box-border caret-transparent flex flex-wrap min-h-[auto] min-w-[auto] mt-3"
            >
              <div
                className="box-border caret-transparent flex basis-[0%] flex-col grow max-w-[35px] min-h-[auto] min-w-[35px] outline-[3px] w-[35px]"
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <b className="text-[16.0583px] font-bold box-border caret-transparent leading-[24.0875px] outline-[3px] md:text-lg md:leading-[27px]">
                          <span className="text-[16.0583px] box-border caret-transparent leading-[24.0875px] outline-[3px] md:text-lg md:leading-[27px]">
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <b className="text-[16.0583px] font-bold box-border caret-transparent leading-[24.0875px] outline-[3px] md:text-lg md:leading-[27px]">
                          The Longevity Protocol Blueprint
                        </b>
                        {" - "}Complete biomarker tracking and optimization guide
                        (Value:{" "}
                        <span className="text-[16.0583px] box-border caret-transparent leading-[24.0875px] outline-[3px] md:text-lg md:leading-[27px]">
                          $97
                        </span>
