import { AmalaOfferList } from "../AmalaOfferSection/components/AmalaOfferList";
import { AmalaPricingBlock } from "../AmalaOfferSection/components/AmalaPricingBlock";
import { AmalaOfferCta } from "../AmalaOfferSection/components/AmalaOfferCta";
import { OFFER_SECTION_ID } from "../../config/links";

export const AmalaOfferSection = () => {
  return (
    <section
      id={OFFER_SECTION_ID}
              ...
              >
                ...
                >
                  ...
                  <div className="items-center box-border caret-transparent flex justify-center min-h-[auto] min-w-[auto] outline-[3px] w-full mt-[25px]">
                    ...
                    <img
                      title=""
                      src="/lp-images-files-videos-fonts/images/amala/6.svg"
                      alt=""
                    ...
                    <img
                      title=""
                      src="/lp-images-files-videos-fonts/images/amala/5.svg"
                      alt=""
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <img
                                src="/lp-images-files-videos-fonts/images/amala/8.png"
                                alt=""
                                title=""
                                className="box-border caret-transparent h-full max-w-full min-h-[auto] min-w-[auto] outline-[3px] w-full"
                              />
