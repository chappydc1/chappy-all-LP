                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            Neutralizes Cytotoxic Free Radicals &amp; Protects
                      ...
                      >
                        ...
                        >
                          <p
                            className="text-[16.0583px] box-border caret-transparent leading-[24.0875px] outline-[3px] md:text-base md:leading-6"
                          >
                            Supports Sustained Energy &amp; Eliminates Afternoon
                            Crashes
                          </p>
                        </div>
                      </div>
                      ...
                      >
                        ...
                        >
                          <p
                            className="text-[16.0583px] box-border caret-transparent leading-[24.0875px] outline-[3px] md:text-base md:leading-6"
                          >
                            Crosses Blood-Brain Barrier for Cognitive Clarity
                            &amp; Neuroprotection
                          </p>
                        </div>
                      </div>
                      ...
                      >
                        ...
                        >
                          <p
                            className="text-[16.0583px] box-border caret-transparent leading-[24.0875px] outline-[3px] md:text-base md:leading-6"
                          >
                            Naturally Reduces Inflammation &amp; Supports Faster
                            Recovery
                          </p>
                        </div>
                      </div>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <div
                        className="text-[16.0583px] box-border caret-transparent leading-[24.0875px] min-h-[auto] min-w-[auto] outline-[3px] text-left w-full md:text-base md:leading-6"
                      >
                        <div
                          className="text-[16.0583px] box-border caret-transparent leading-[24.0875px] outline-[3px] w-full md:text-base md:leading-6"
                        >
                          <p
                            className="text-black text-[16.0583px] box-border caret-transparent leading-[24.0875px] outline-[3px] md:text-base md:leading-6"
                          >
                            Dissolves Quickly with a Light, Refreshing
                            Effervescence
                          </p>
                        </div>
                      </div>
