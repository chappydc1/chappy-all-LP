export type AmalaContentSectionProps = {
...
export const AmalaContentSection = (props: AmalaContentSectionProps) => {
  return (
    <section
      className={
    ...
    >
      ...
      <div className="text-zinc-800 flex flex-col max-w-[1170px] w-full gap-8 md:flex-row md:gap-12 md:items-start">
        ...
        <div className={`hidden md:block md:w-[45%] md:shrink-0${props.desktopImageAlignment === "center" ? " md:self-center" : props.desktopImageAlignment === "end" ? " md:self-end" : ""}`}>
          <img
      ...
      {props.showBottomSection && props.benefitsTitle && (
        <div className="text-zinc-800 flex flex-col max-w-[1170px] w-full gap-8 mt-[50px] md:flex-row md:gap-12 md:mt-[60px] md:items-center">
          {/* Desktop image left */}
          <div className="hidden md:block md:w-[45%] md:shrink-0">
            <img
