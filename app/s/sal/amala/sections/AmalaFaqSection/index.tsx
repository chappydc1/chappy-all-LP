import { AmalaFaqItem } from "../AmalaFaqSection/components/AmalaFaqItem";
import { AmalaCtaBanner } from "../../components/AmalaCtaBanner";

export const AmalaFaqSection = () => {
  return (
    <section
                  ...
                  >
                    ...
                    >
                      <AmalaFaqItem
                        ...
                        rootClassName=""
                        iconSrc="/lp-images-files-videos-fonts/images/amala/icon-1.svg"
                        iconAlt="Icon"
                      />
                    </div>
                  </div>
