export const AmalaBrandHeader = () => {
  return (
    <section
      className="items-center bg-no-repeat box-border caret-transparent flex flex-col justify-items-center min-h-[auto] min-w-[auto] outline-[3px] w-full border-stone-300 bg-center p-[15px] border-b"
    >
      <div
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <img
                src="/lp-images-files-videos-fonts/images/amala/1763702719034_amalahealth.webp"
                alt=""
                sizes="155px"
                title=""
                className="box-border caret-transparent h-full max-w-full min-h-[auto] min-w-[auto] outline-[3px] w-[140px] md:w-[155px]"
              />
            </div>
          </div>
        </div>
