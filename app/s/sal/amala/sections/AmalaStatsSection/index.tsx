import { AmalaStatItem } from "../AmalaStatsSection/components/AmalaStatItem";

export const AmalaStatsSection = () => {
  return (
    <section
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    Real Feedback From Prime Cell H2 Customers
                  </strong>
                </p>
              </div>
            </div>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <AmalaStatItem
                          percentage="82%"
                          description="Reported significant improvements in sustained daily energy without stimulants within the first 3 weeks of use.*"
                          wrapperClassName=" "
                          innerClassName=""
                          contentClassName=""
                          highlightWrapperClassName=""
                          highlightInnerClassName=""
                        />
                        <div
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <AmalaStatItem
                                  percentage="78%"
                                  description="Experienced faster workout recovery and reduced muscle soreness, with some noticing improvements within 7-10 days.*"
                                  wrapperClassName=""
                                  innerClassName=""
                                  contentClassName=""
                                  highlightWrapperClassName=""
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <AmalaStatItem
                                  percentage="71%"
                                  description="Felt sharper mental clarity, better focus, and improved memory within 2-4 weeks of consistent use.*"
                                  wrapperClassName=""
                                  innerClassName=""
                                  contentClassName=""
                                  highlightWrapperClassName=""
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <AmalaStatItem
                                  percentage="68%"
                                  description="Noticed visible anti-aging effects including improved skin quality, reduced fine lines, and more vibrant appearance within 8-12 weeks.*"
                                  wrapperClassName=""
                                  innerClassName=""
                                  contentClassName=""
                                  highlightWrapperClassName=""
                ...
                >
                  ...
                  >
                    *Results based on a voluntary, self-reported customer survey
                    conducted by PrimeCell H2 in 2025. Individual results may
                    vary.
                  </strong>
                </p>
              </div>
