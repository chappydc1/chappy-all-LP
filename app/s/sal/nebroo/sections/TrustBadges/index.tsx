      ...
      <div ref={ref} className="max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row">
          <div className={`reveal delay-100 ${visible ? "visible" : ""} flex-1`}>
            <NebrooTrustBadgeItem
              imageSrc="/lp-images-files-videos-fonts/images/nebroo/1729160735276_120_days.webp"
          ...
          <div className={`reveal delay-200 ${visible ? "visible" : ""} flex-1`}>
            <NebrooTrustBadgeItem
              imageSrc="/lp-images-files-videos-fonts/images/nebroo/1729160748904_Free_shipping.webp"
              title="FREE SHIPPING"
          ...
          <div className={`reveal delay-300 ${visible ? "visible" : ""} flex-1`}>
            <NebrooTrustBadgeItem
              imageSrc="/lp-images-files-videos-fonts/images/nebroo/1729160838424_Guaranteed_High_Quality.webp"
