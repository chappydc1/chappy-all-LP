  ...
  return (
    <div className="text-black text-[32px] font-bold bg-white box-border caret-transparent basis-[0%] shrink-0 leading-8 text-left pt-px pb-2.5 px-2.5 rounded-[1px] font-montserrat md:bg-transparent md:leading-[38px]">
      <div className="text-red-600 box-border caret-transparent leading-[34px] md:leading-[38px]">
        <span className="text-neutral-800 text-[25px] box-border caret-transparent basis-[0%] shrink-0 leading-[27px] rounded-[1px] md:text-[35px] md:leading-[38px]">
          Struggling To Hear Conversations, And Tired Of Asking People To Repeat
          Themselves? Instantly Improve Your Hearing Without Breaking The Bank.
        </span>
      </div>
    </div>
  );
