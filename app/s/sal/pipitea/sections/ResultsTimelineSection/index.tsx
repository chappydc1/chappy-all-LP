import { PipiteaTimelineItem } from "./components/PipiteaTimelineItem";
                  ...
                  >
                    ...
                    >
                      <PipiteaTimelineItem
                        ...
                        timeLabel="1 Week"
                        description="Experience the immediate pleasure of a drink you actually enjoy. Notice you're feeling calmer overall - no caffeine spikes, no stress hormones elevated. Sleep quality may improve, which directly supports healthy kidney function."
                      />
                    </div>
                  </div>
                  <div
                  ...
                  >
                    ...
                    >
                      <PipiteaTimelineItem
                        ...
                        timeLabel="1 Month"
                        description="See early changes. Many users notice their eGFR readings starting to stabilize. The daily ritual is established. You're doing something proactive for your kidney health, which reduces the stress and anxiety around it."
                      />
                    </div>
                  </div>
                  <div
                  ...
                  >
                    ...
                    >
                      <PipiteaTimelineItem
                        ...
                        timeLabel="2 Months"
                        description="Experience measurable improvements. eGFR readings often show consistent improvement at this stage. The kidney-supporting compounds are working at the cellular level. The habit is effortless."
                      />
                    </div>
                  </div>
                  <div
                  ...
                  >
                    ...
                    >
                      <PipiteaTimelineItem
                        ...
                        contentVariant="border-pink-950 after:border-l-pink-950 after:border-r-zinc-800 after:right-[-15px] after:border-l-[13px]"
                        timeLabel="3 Months"
                        description="Feel the full kidney benefits. eGFR readings are noticeably improved. Doctors often comment positively at checkups. Creatinine markers may also show improvement. You feel confident and in control of your kidney health."
                      />
                    </div>
                  </div>
                  <div
                  ...
                  >
                    ...
                    >
                      <PipiteaTimelineItem
                        ...
                        timeLabel="6 Months"
                        description="Thrive with sustained kidney support. Consistent, healthy readings. Less anxiety about checkups. Improved overall kidney markers. The compound benefits of daily antioxidant and ACE-inhibitor-like support are fully realized."
                      />
                    </div>
                  </div>
                  <div
                  ...
                  >
                    ...
                    >
                      <PipiteaTimelineItem
                        ...
                        timeLabel="12 Months"
                        description="Maintain healthy kidney function with a sustainable habit you genuinely enjoy. No side effects to manage. No prescriptions to refill. Just a delicious daily ritual that happens to be incredibly good for your kidneys."
                      />
                    </div>
                  </div>
                </div>
