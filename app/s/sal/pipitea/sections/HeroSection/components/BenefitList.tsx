export const PipiteaBenefitList = () => {
  return (
    <div
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        Supports Healthy eGFR Already in Normal Range
                      </p>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {" "}
                        Delivers Powerful Antioxidant Protection for Your
                  ...
                  >
                    ...
                    >
                      <p
                        className="text-[16.0583px] box-border caret-transparent leading-[24.0875px] outline-[3px] md:text-base md:leading-6"
                      >
                        Gentle &amp; Natural, No Prescription Side Effects to
                        Worry About
                      </p>
                    </div>
                  </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <span className="text-[16.0583px] box-border caret-transparent leading-[24.0875px] outline-[3px] md:text-base md:leading-6">
                          {" "}
                          Caffeine-Free So It Won&#39;t Spike Stress Hormones or
                          Disrupt Sleep
                        </span>
                      </p>
                    </div>
