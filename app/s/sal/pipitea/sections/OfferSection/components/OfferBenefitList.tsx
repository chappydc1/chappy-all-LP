                ...
                >
                  ...
                  >
                    <img
                      ...
                      title=""
                      className="box-border caret-transparent max-w-full min-h-[auto] min-w-[auto] outline-[3px] w-[22px]"
                    />
                  </div>
                </div>
              </div>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        Premium Organic Hibiscus Tea (30+ servings of daily
                        kidney support)
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    >
                      <p
                        ...
                        className="text-[16.0583px] box-border caret-transparent leading-[24.0875px] outline-[3px] md:text-lg md:leading-[27px]"
                      >
                        The Kidney Health Ritual Guide: Optimal preparation tips
                        and timing strategies for maximum kidney benefits
                        (Value:{" "}
