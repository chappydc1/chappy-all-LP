    ...
    <div className="bg-white box-border caret-transparent flex min-h-[auto] min-w-[auto] outline-[3px] w-full border border-pink-950 mt-5 pl-[5px] pr-px pt-4 pb-px rounded-[10px] border-solid md:px-4">
      <div className="box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px] w-full px-2.5 py-3">
        ...
        >
          ...
          health. The research on its nephroprotective benefits is robust -
          we&#39;re talking over 100 peer-reviewed studies showing real effects
          on eGFR and creatinine readings. What makes it special is that
          patients actually enjoy drinking it, which means they stick with it.
          Consistency is everything for kidney function management, and this is
          something people will actually do daily.&quot;
        </p>
      ...
      <div className="items-end self-end box-border caret-transparent flex min-h-[auto] min-w-[auto] outline-[3px] w-[66%] p-px md:[align-items:normal] md:block md:w-2/5">
        <img
          title=""
          src=""
