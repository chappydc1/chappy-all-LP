import { PipiteaOfferBenefitList } from "./PipiteaOfferBenefitList";
import { PipiteaOfferCta } from "./PipiteaOfferCta";
import { PipiteaDoctorReview } from "./PipiteaDoctorReview";
    ...
    >
      ...
      <div className="text-black text-lg font-semibold box-border caret-transparent leading-[27px] min-h-[auto] min-w-[auto] outline-[3px] text-center mt-5 p-px font-libre_franklin">
        <u className="box-border caret-transparent outline-[3px] underline">
          Try Our Caffeine-Free Hibiscus Tea for Kidney Function Support 100%
          Risk-Free
        </u>
      </div>
      <div
      ...
      >
        ...
        >
          ...
          >
            <strong
              className="text-[22px] font-bold box-border caret-transparent leading-[26.4px] outline-[3px]"
            >
              Total Value:{" "}
            ...
            <h2
              className="text-[27.0583px] font-medium box-border caret-transparent leading-[32.47px] outline-[3px] mt-2.5 md:text-3xl md:leading-9"
            >
              <strong
              ...
              >
                ...
                >
                  <img
                    ...
                    alt=""
                    title=""
                    className="box-border caret-transparent max-w-full min-h-[auto] min-w-[auto] outline-[3px] w-[450px]"
                  />
                </div>
              </div>
            </div>
