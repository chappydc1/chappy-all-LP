...
export const SurveyStat = (props: SurveyStatProps) => {
  return (
    <div className="box-border caret-transparent basis-[0%] grow min-h-[auto] min-w-[auto] outline-[3px] w-full">
      ...
      <div
        className={`text-black text-xl font-semibold box-border caret-transparent tracking-[-0.6px] leading-[26px] outline-[3px] text-left mt-3 pr-0 font-montserrat ${props.titleVariant}`}
      >
        {props.title}
      </div>
