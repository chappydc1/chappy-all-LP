        ...
        <div className="text-[15px] box-border caret-transparent leading-[19.5px] outline-[3px] md:text-base md:leading-[20.8px]">
          ...
          <div className="text-[15px] box-border caret-transparent leading-[19.5px] outline-[3px] md:text-base md:leading-[20.8px]">
            *These statements have not been approved by the Food and Drug
            ...
            cure, or prevent any disease. Testimonials found at tryrosabella.com
            are unverified results, and may not reflect the typical
          ...
          <div className="text-[15px] box-border caret-transparent leading-[19.5px] outline-[3px] md:text-base md:leading-[20.8px]">
            Information on the Rosabella website is provided for informational
            purposes only. It is not meant to substitute for medical advice from
            your physician or other medical professional. You should not use the
