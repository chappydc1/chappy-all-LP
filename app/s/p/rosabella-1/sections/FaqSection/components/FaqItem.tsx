  ...
  return (
    <details className="box-border caret-transparent outline-[3px] group">
      ...
      <div className="box-border caret-transparent outline-[3px] text-left mt-0 pb-5 px-5 md:-mt-3 md:pb-[27px] md:px-[18px]">
        <div className="text-black text-[15px] box-border caret-transparent tracking-[-0.32px] leading-[19.5px] outline-[3px] font-montserrat md:text-lg md:leading-[23.4px]">
          {props.answer}
        </div>
      </div>
    </details>
