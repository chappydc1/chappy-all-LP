import { SleepApneaHero } from "../Hero";
import { SleepApneaBenefitSection } from "../BenefitSection";
import { SleepApneaTestimonialsSection } from "../TestimonialsSection";
import { SleepApneaReviewsSection } from "../ReviewsSection";
...
const benefitImageConfigs = [
  ...
  },
  {
    ...
    primaryImageAlt: "Woman showing a SleepApnea liquid drops bottle",
...
export const SleepApneaMainContent = () => {
  return (
    <main
      role="main"
    ...
    >
      ...
      <SleepApneaTestimonialsSection />
      <SleepApneaReviewsSection />
    </main>
  );
};
