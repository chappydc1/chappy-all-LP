export type SleepApneaPurchaseOptionsProps = {
  variant: string;
  title: string;
  actionText?: string;
  iconUrl?: string;
...
export const SleepApneaPurchaseOptions = (props: SleepApneaPurchaseOptionsProps) => {
  const iconUrl =
    props.iconUrl ?? "/lp-images-files-videos-fonts/images/gruns/icon-16.svg";
  const modalCloseIconUrl =
    props.modalCloseIconUrl ??
    "/lp-images-files-videos-fonts/images/gruns/icon-17.svg";
