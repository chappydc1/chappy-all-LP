export const SleepApneaProductDetails = () => {
  return (
    <div className="box-border caret-transparent max-w-none min-h-0 min-w-0 outline-[3px] w-auto md:max-w-[470px] md:min-h-[auto] md:min-w-[470px] md:w-[470px]">
      <div className="box-border caret-transparent outline-[3px] w-full">
        <div className="box-border caret-transparent outline-[3px]">
          <div className="box-border caret-transparent outline-[3px] mb-2 md:mb-3">
            <a
              href="#reviews"
              className="text-sm font-medium items-center box-border caret-transparent gap-x-3 flex justify-start leading-[22.4px] outline-[3px] gap-y-3 underline md:text-base md:leading-[25.6px]"
            >
              <span className="text-sm box-border caret-transparent block leading-[22.4px] min-h-[auto] min-w-[auto] outline-[3px] md:text-base md:leading-[25.6px]">
                <span className="text-sm items-center box-border caret-transparent flex h-4 justify-start leading-[22.4px] outline-[3px] md:text-base md:leading-[25.6px]">
                  <span className="text-green-700 text-sm box-border caret-transparent block h-4 leading-[22.4px] min-h-[auto] min-w-[auto] outline-[3px] w-4 overflow-clip md:text-base md:leading-[25.6px]">
                    <img
                      src="/lp-images-files-videos-fonts/images/gruns/icon-15.svg"
                      alt="Icon"
              ...
              <span className="text-sm box-border caret-transparent block leading-[22.4px] min-h-[auto] min-w-[auto] outline-[3px] md:text-base md:leading-[25.6px]">
                4.8/5.0 (100,000), 1M+ Customers
              </span>
            </a>
          </div>
        </div>
        <div className="box-border caret-transparent outline-[3px]">
          <div className="box-border caret-transparent outline-[3px] mb-2">
            <h1 className="text-green-700 text-[32px] font-bold box-border caret-transparent tracking-[-1.6px] leading-[38.4px] outline-[3px] text-left md:text-[44px] md:tracking-[-2.2px] md:leading-[48.4px]">
              Daily Gut Health Support Made Simple
            </h1>
          </div>
        </div>
        <div className="box-border caret-transparent outline-[3px]">
          <div className="box-border caret-transparent outline-[3px] mb-2 md:mb-3">
            <p className="text-base font-semibold box-border caret-transparent tracking-[normal] leading-[22.4px] outline-[3px] md:text-xl md:tracking-[-1px] md:leading-6">
              Packed with 60 + ingredients including organic fruits, prebiotics,
              and adaptogens to fill nutrient gaps, support digestion, and fuel
              steady energy.
            </p>
          </div>
        </div>
        <div className="box-border caret-transparent outline-[3px]">
          <div className="box-border caret-transparent outline-[3px] mb-6 pt-6 border-t border-solid">
            <div className="items-baseline box-border caret-transparent flex justify-between outline-[3px]">
              ...
              <button className="text-base font-medium items-center bg-transparent caret-transparent gap-x-0.5 hidden justify-start leading-[19.2px] outline-[3px] gap-y-0.5 text-center p-0 border-b border-black">
                Tastes Like{" "}
                <img
                  src="/lp-images-files-videos-fonts/images/gruns/icon-16.svg"
                  alt="Icon"
            ...
            <div className="box-border caret-transparent outline-[3px] mt-1 mb-5">
              ...
              <span className="text-base italic font-medium box-border caret-transparent hidden leading-[19.2px] outline-[3px]">
                Sweet cherry, tart lemon-lime and blue raspberry.
              </span>
            </div>
            <div className="items-start box-border caret-transparent gap-x-4 flex justify-start outline-[3px] gap-y-4">
              <a
                href="#"
              ...
              >
                <div className="relative bg-neutral-200 box-border caret-transparent h-[88px] min-h-[auto] min-w-[auto] outline-[3px] w-[88px] z-0 border overflow-clip rounded-[88px] border-solid">
                  <img
                    src="/lp-images-files-videos-fonts/images/gruns/16.avif"
                    alt="SleepApnea"
              ...
              >
                <div className="relative bg-white box-border caret-transparent h-[88px] min-h-[auto] min-w-[auto] outline-[3px] w-[88px] z-0 border overflow-clip rounded-[88px] border-solid">
                  <img
                    src="/lp-images-files-videos-fonts/images/gruns/15.avif"
                    alt="Popsicle® Firecracker SleepApnea"
                    className="absolute aspect-[auto_108_/_108] box-border caret-transparent h-[108px] max-w-full min-w-[108px] outline-[3px] w-[108px] -left-2.5 top-0"
                  />
                </div>
            ...
            <div className="fixed items-center box-border caret-transparent hidden h-full justify-center outline-[3px] pointer-events-none w-full left-0 top-0">
              <div className="relative bg-white box-border caret-transparent outline-[3px] m-5 px-5 py-[34px] rounded-xl md:m-40 md:p-8">
                <button className="absolute bg-transparent caret-transparent block shrink-0 h-5 outline-[3px] text-center w-5 p-0 right-2 top-2">
                  <img
                    src="/lp-images-files-videos-fonts/images/gruns/icon-17.svg"
                    alt="Icon"
                ...
                <div className="box-border caret-transparent outline-[3px]">
                  <div className="box-border caret-transparent outline-[3px]">
                    <div className="box-border caret-transparent outline-[3px]">
                      <img
                        src="/lp-images-files-videos-fonts/images/gruns/58.webp"
                    ...
                    <div className="box-border caret-transparent block outline-[3px] md:hidden">
                      <img
                        src="/lp-images-files-videos-fonts/images/gruns/54.webp"
                ...
                <div className="box-border caret-transparent hidden outline-[3px]">
                  <div className="box-border caret-transparent outline-[3px]">
                    <div className="box-border caret-transparent outline-[3px]">
                      <img
                        src="/lp-images-files-videos-fonts/images/gruns/59.webp"
                        className="aspect-[auto_1632_/_746] box-border caret-transparent max-w-full outline-[3px] w-[1632px]"
                      />
                    </div>
                    <div className="box-border caret-transparent block outline-[3px] md:hidden">
                      <img
                        src="/lp-images-files-videos-fonts/images/gruns/55.webp"
        ...
        <div className="box-border caret-transparent outline-[3px]">
          <div className="box-border caret-transparent outline-[3px] mb-6 pt-6 border-t border-solid">
            <div className="items-baseline box-border caret-transparent flex justify-between outline-[3px] mb-4">
              <div className="box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px]">
                <h3 className="text-base font-bold box-border caret-transparent inline-block leading-[25.6px] outline-[3px] md:text-xl md:leading-8">
                  Select Sugar Level
                </h3>
            ...
            <div className="items-center box-border caret-transparent gap-x-4 flex justify-start outline-[3px] gap-y-4">
              <div className="items-center box-border caret-transparent gap-x-4 flex justify-start min-h-[auto] min-w-[auto] outline-[3px] gap-y-4 w-full">
              ...
              <div className="relative bg-white box-border caret-transparent outline-[3px] m-5 px-5 py-[34px] rounded-xl md:m-40 md:p-8">
                ...
                <div className="box-border caret-transparent outline-[3px]">
                  <div className="box-border caret-transparent outline-[3px]">
                    <div className="box-border caret-transparent outline-[3px]">
                      <img
                        src="/lp-images-files-videos-fonts/images/gruns/49.webp"
                        className="box-border caret-transparent max-w-full outline-[3px]"
                      />
                    </div>
                    <div className="box-border caret-transparent block outline-[3px] md:hidden">
                      <img
                        src="/lp-images-files-videos-fonts/images/gruns/50.webp"
                        className="box-border caret-transparent max-w-full outline-[3px]"
                      />
                    </div>
                  </div>
                ...
                <div className="box-border caret-transparent hidden outline-[3px]">
                  <div className="box-border caret-transparent outline-[3px]">
                    <div className="box-border caret-transparent outline-[3px]">
                      <img
                        src="/lp-images-files-videos-fonts/images/gruns/51.webp"
                        className="box-border caret-transparent max-w-full outline-[3px]"
                      />
                    </div>
                    <div className="box-border caret-transparent block outline-[3px] md:hidden">
                      <img
                        src="/lp-images-files-videos-fonts/images/gruns/56.webp"
                        className="box-border caret-transparent max-w-full outline-[3px]"
                      />
                    </div>
                  </div>
        ...
        <div className="box-border caret-transparent outline-[3px]">
          <div className="box-border caret-transparent outline-[3px] mb-6 pt-6 border-t border-solid">
            <div className="items-center box-border caret-transparent gap-x-4 flex justify-start outline-[3px] gap-y-4 mb-4">
              <div className="box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px]">
                <h3 className="text-base font-bold box-border caret-transparent inline-block leading-[25.6px] outline-[3px] md:text-xl md:leading-8">
                  How many Adults?
                </h3>
              ...
              <span className="text-green-950 text-sm font-medium items-center box-border caret-transparent gap-x-1 flex leading-[16.8px] min-h-[auto] min-w-[auto] opacity-50 outline-[3px] gap-y-1 border border-green-950 px-2 py-1 rounded-bl rounded-br rounded-tl rounded-tr border-dashed">
                <span className="box-border caret-transparent block h-4 min-h-[auto] min-w-[auto] outline-[3px] w-4">
                  <img
                    src="/lp-images-files-videos-fonts/images/gruns/icon-18.svg"
                    alt="Icon"
            ...
            <div className="box-border caret-transparent outline-[3px]">
              <fieldset className="bg-white box-border caret-transparent outline-[3px] w-full border overflow-hidden p-[5px] rounded-[3.35544e+07px] border-solid border-black">
                ...
                <div className="box-border caret-transparent flex outline-[3px] w-full">
                  <input
                    type="radio"
                    name="qty-template--18470695305282__usnacks_buybox_tPQwET-AMFZ2cXBjU0VHcFg0e__usnacks_buybox_quantity_selector_FXBDcb-7362502557762"
                    value="1"
              ...
              <fieldset className="bg-white box-border caret-transparent hidden outline-[3px] w-full border overflow-hidden p-[5px] rounded-[3.35544e+07px] border-solid border-black">
                <legend className="absolute box-border caret-transparent h-px outline-[3px] text-nowrap w-px overflow-hidden -m-px px-0">
                  How many Adults?
                </legend>
                <div className="box-border caret-transparent flex outline-[3px] w-full">
                  <input
                    type="radio"
                    name="qty-template--18470695305282__usnacks_buybox_tPQwET-AMFZ2cXBjU0VHcFg0e__usnacks_buybox_quantity_selector_FXBDcb-7719362428994"
                    value="1"
                    className="absolute bg-transparent box-border caret-transparent block h-px outline-[3px] text-nowrap w-px overflow-hidden -m-px p-0"
                  />
        ...
        <div className="box-border caret-transparent outline-[3px]">
          <div className="box-border caret-transparent outline-[3px]">
              ...
              <form className="box-border caret-transparent outline-[3px]">
                ...
                <div className="box-border caret-transparent outline-[3px] mb-5 md:mb-6">
                  <ul className="box-border caret-transparent gap-x-4 flex flex-col list-none outline-[3px] gap-y-4 pl-0 pt-4 md:gap-x-5 md:gap-y-5">
                    <li className="relative box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px]">
                      <button
                        type="button"
                        ...
                        <div className="box-border caret-transparent h-[115px] outline-[3px] overflow-hidden ml-6 md:h-[119px]">
                          <div className="box-border caret-transparent outline-[3px] pt-2 pb-3 md:pb-4">
                            <ul className="items-start box-border caret-transparent gap-x-2 flex flex-col justify-start outline-[3px] gap-y-2 pl-0">
                              <li className="box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px] py-0.5">
                                <div className="items-center box-border caret-transparent gap-x-2 flex justify-start outline-[3px] gap-y-2">
                                  <span className="box-border caret-transparent block h-[18px] min-h-[auto] min-w-[auto] outline-[3px] w-[18px]">
                                    <img
                                      src="/lp-images-files-videos-fonts/images/gruns/35.svg"
                            ...
                            <ul className="items-start box-border caret-transparent gap-x-3 flex justify-start outline-[3px] gap-y-3 pl-0">
                              <li className="box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px] py-0.5">
                                <div className="items-center box-border caret-transparent gap-x-2 flex justify-start outline-[3px] gap-y-2">
                                  <span className="box-border caret-transparent block h-[18px] min-h-[auto] min-w-[auto] outline-[3px] w-[18px]">
                                    <img
                                      src="/lp-images-files-videos-fonts/images/gruns/33.svg"
                ...
                <div className="box-border caret-transparent hidden outline-[3px] mb-5 md:mb-6">
                  <ul className="box-border caret-transparent gap-x-4 flex flex-col list-none outline-[3px] gap-y-4 pl-0 pt-4 md:gap-x-5 md:gap-y-5">
                    <li className="relative box-border caret-transparent outline-[3px]">
                      <button
                        type="button"
                        className="bg-neutral-200 caret-transparent outline-[3px] text-left w-full border border-emerald-900 overflow-clip p-0 rounded-lg"
                      >
                        ...
                        <div className="items-start box-border caret-transparent flex justify-start outline-[3px] w-full pt-3 px-3 md:pt-4 md:px-4">
                          <span className="relative box-border caret-transparent block shrink-0 h-[18px] outline-[3px] w-[18px] border border-emerald-900 mr-1.5 mt-0 rounded-[3.35544e+07px] border-solid md:mt-[3px] after:accent-auto after:bg-emerald-900 after:box-border after:caret-transparent after:text-black after:block after:text-xl after:not-italic after:normal-nums after:font-normal after:h-2.5 after:tracking-[normal] after:leading-8 after:list-outside after:list-none after:outline-[3px] after:pointer-events-auto after:absolute after:text-left after:no-underline after:indent-[0px] after:normal-case after:visible after:w-2.5 after:rounded-[50%] after:border-separate after:left-2/4 after:top-2/4 after:font-work_sans"></span>
                          <div className="items-start box-border caret-transparent gap-x-1 flex flex-col grow outline-[3px] gap-y-1 md:gap-x-2 md:gap-y-2">
                            <span className="text-lg font-bold box-border caret-transparent block leading-[21.6px] outline-[3px] md:text-xl md:leading-6">
                              Subscribe &amp; Save
                            </span>
                            <span className="text-sm font-medium box-border caret-transparent block leading-[16.8px] outline-[3px]">
                              28 packs each 4 weeks
                            </span>
                          </div>
                          <div className="items-end box-border caret-transparent gap-x-1 flex flex-col shrink-0 outline-[3px] gap-y-1 text-right ml-auto md:gap-x-2 md:gap-y-2">
                            <div className="items-center box-border caret-transparent gap-x-1 flex outline-[3px] gap-y-1">
                              <span className="text-lg font-bold box-border caret-transparent block leading-[18px] outline-[3px] md:text-xl md:leading-5">
                                $44.88
                              </span>
                              <span className="box-border caret-transparent flex outline-[3px]">
                                <span className="text-[lab(35.6337_-1.58697_-10.8425)] text-sm font-bold box-border caret-transparent block leading-[22.4px] outline-[3px] line-through">
                                  $87.99
                                </span>
                              </span>
                            </div>
                            <span className="text-xs font-medium box-border caret-transparent block leading-[19.2px] outline-[3px]">
                              $1.60/day
                            </span>
                          </div>
                        </div>
                        <div className="box-border caret-transparent h-0 outline-[3px] overflow-hidden ml-6">
                          <div className="box-border caret-transparent outline-[3px] pt-2 pb-3 md:pb-4">
                            <ul className="items-start box-border caret-transparent gap-x-2 flex flex-col justify-start outline-[3px] gap-y-2 pl-0">
                              <li className="box-border caret-transparent outline-[3px] py-0.5">
                                <div className="items-center box-border caret-transparent gap-x-2 flex justify-start outline-[3px] gap-y-2">
                                  ...
                                  <span className="text-sm font-medium box-border caret-transparent block leading-[22.4px] outline-[3px]">
                                    FAST &amp; FREE Shipping On First Order
                                  </span>
                                </div>
                              </li>
                    ...
                    <li className="relative box-border caret-transparent outline-[3px]">
                      ...
                      >
                        <div className="items-start box-border caret-transparent flex justify-start outline-[3px] w-full">
                          <span className="relative box-border caret-transparent block shrink-0 h-[18px] outline-[3px] w-[18px] border mr-1.5 mt-0 rounded-[3.35544e+07px] border-solid md:mt-[3px]"></span>
                          <div className="items-start box-border caret-transparent gap-x-0.5 flex flex-col grow outline-[3px] gap-y-0.5">
                            <span className="text-lg font-bold box-border caret-transparent block leading-[21.6px] outline-[3px]">
                              One Time Purchase
                            </span>
                            <span className="text-sm font-medium box-border caret-transparent block leading-[16.8px] outline-[3px]">
                              28 packs delivered once
                          ...
                          <div className="items-end box-border caret-transparent flex flex-col shrink-0 outline-[3px] text-right ml-auto">
                            <div className="box-border caret-transparent gap-x-1 flex outline-[3px] gap-y-1">
                              <span className="text-lg font-bold box-border caret-transparent block leading-[18px] outline-[3px] md:text-xl md:leading-5">
                                $59.84
                              </span>
                              <span className="box-border caret-transparent flex outline-[3px]">
            ...
            <div className="bg-white box-border caret-transparent hidden outline-[3px]">
              <div className="box-border caret-transparent outline-[3px]">
                <h3 className="text-base font-bold box-border caret-transparent inline-block leading-[25.6px] outline-[3px] md:text-xl md:leading-8">
                  Autoship and Save:
                </h3>
              ...
              <form className="box-border caret-transparent outline-[3px]">
                ...
                <div className="box-border caret-transparent outline-[3px] mb-5 md:mb-6">
                  <ul className="box-border caret-transparent gap-x-4 flex flex-col list-none outline-[3px] gap-y-4 pl-0 pt-4 md:gap-x-5 md:gap-y-5">
                    <li className="relative box-border caret-transparent outline-[3px]">
                      <button
                        type="button"
                        className="bg-rose-100 caret-transparent outline-[3px] text-left w-full border border-red-700 overflow-clip p-0 rounded-lg"
                      >
                        <div className="text-white text-xs font-bold bg-red-700 box-border caret-transparent leading-3 outline-[3px] text-center uppercase w-full p-1.5 md:text-sm md:leading-[22.4px]">
                          <span className="text-xs box-border caret-transparent leading-3 outline-[3px] md:text-sm md:leading-[22.4px]">
                            Most Popular: Get 49% Off
                          </span>
                          <span className="text-xs box-border caret-transparent hidden leading-3 outline-[3px] md:text-sm md:leading-[22.4px]">
                        ...
                        <div className="items-start box-border caret-transparent flex justify-start outline-[3px] w-full pt-3 px-3 md:pt-4 md:px-4">
                          <span className="relative box-border caret-transparent block shrink-0 h-[18px] outline-[3px] w-[18px] border border-red-700 mr-1.5 mt-0 rounded-[3.35544e+07px] border-solid md:mt-[3px] after:accent-auto after:bg-red-700 after:box-border after:caret-transparent after:text-black after:block after:text-xl after:not-italic after:normal-nums after:font-normal after:h-2.5 after:tracking-[normal] after:leading-8 after:list-outside after:list-none after:outline-[3px] after:pointer-events-auto after:absolute after:text-left after:no-underline after:indent-[0px] after:normal-case after:visible after:w-2.5 after:rounded-[50%] after:border-separate after:left-2/4 after:top-2/4 after:font-work_sans"></span>
                          <div className="items-start box-border caret-transparent gap-x-1 flex flex-col grow outline-[3px] gap-y-1 md:gap-x-2 md:gap-y-2">
                            <span className="text-lg font-bold box-border caret-transparent block leading-[21.6px] outline-[3px] md:text-xl md:leading-6">
                              Subscribe &amp; Save
                            </span>
                          ...
                          <div className="items-end box-border caret-transparent gap-x-1 flex flex-col shrink-0 outline-[3px] gap-y-1 text-right ml-auto md:gap-x-2 md:gap-y-2">
                            ...
                            <span className="text-red-700 text-xs font-medium box-border caret-transparent block leading-[19.2px] outline-[3px]">
                              $1.55/day
                            </span>
                          </div>
                        </div>
                ...
                <div className="items-stretch box-border caret-transparent gap-x-3 flex outline-[3px] gap-y-3 mt-3 mb-6">
                  <button
                    type="submit"
                    className="text-white text-lg font-semibold items-center bg-blue-950 caret-transparent gap-x-1.5 flex grow h-14 justify-center leading-7 outline-[3px] gap-y-1.5 text-center border px-2 py-0 rounded-[3.35544e+07px] border-black"
                  >
                    <span className="box-border caret-transparent block tracking-[-0.54px] outline-[3px]">
                      Start Now
                    </span>
                  </button>
                </div>
                <div className="bg-amber-100 box-border caret-transparent inline-block outline-[3px] text-center w-full overflow-hidden mb-6 p-2 rounded-lg">
                  <div className="box-border caret-transparent flex flex-col outline-[3px]">
                    <span className="text-base font-medium box-border caret-transparent block leading-[19.2px] outline-[3px]">
                      Limited Time Discount Auto-Applied ✅
                    </span>
                    <span className="text-base font-medium box-border caret-transparent hidden leading-[25.6px] outline-[3px]">
                      You&#39;re saving{" "}
        ...
        <div className="box-border caret-transparent outline-[3px]">
          <div className="box-border caret-transparent outline-[3px] py-3">
            <ul className="items-start box-border caret-transparent gap-x-3 flex justify-start list-none outline-[3px] gap-y-3 pl-0">
              <li className="box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px] w-[calc(33.3333%_-_9px)]">
                <div className="items-center box-border caret-transparent gap-x-2 flex flex-col justify-start outline-[3px] gap-y-2">
                  <span className="box-border caret-transparent block h-9 min-h-[auto] min-w-[auto] outline-[3px] w-9">
                    <img
                      src="/lp-images-files-videos-fonts/images/gruns/34.svg"
                      alt="30-Day Money-Back Guarantee"
                      className="aspect-[auto_48_/_48] box-border caret-transparent max-w-full outline-[3px] w-12"
                    />
                  </span>
                  <span className="text-sm font-medium box-border caret-transparent block leading-[19.6px] min-h-[auto] min-w-[auto] outline-[3px] text-center">
                    30-Day Money-Back Guarantee
                  </span>
                </div>
              </li>
              <li className="box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px] w-[calc(33.3333%_-_9px)]">
                <div className="items-center box-border caret-transparent gap-x-2 flex flex-col justify-start outline-[3px] gap-y-2">
                  <span className="box-border caret-transparent block h-9 min-h-[auto] min-w-[auto] outline-[3px] w-9">
                    <img
                      src="/lp-images-files-videos-fonts/images/gruns/36.svg"
                      alt="Clinically and 3rd party tested"
                      className="aspect-[auto_48_/_48] box-border caret-transparent max-w-full outline-[3px] w-12"
                    />
                  </span>
                  <span className="text-sm font-medium box-border caret-transparent block leading-[19.6px] min-h-[auto] min-w-[auto] outline-[3px] text-center">
                    Clinically and 3rd party tested
                  </span>
                </div>
              </li>
              <li className="box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px] w-[calc(33.3333%_-_9px)]">
                <div className="items-center box-border caret-transparent gap-x-2 flex flex-col justify-start outline-[3px] gap-y-2">
                  <span className="box-border caret-transparent block h-9 min-h-[auto] min-w-[auto] outline-[3px] w-9">
                    <img
                      src="/lp-images-files-videos-fonts/images/gruns/37.svg"
                  ...
                  <span className="text-sm font-medium box-border caret-transparent block leading-[19.6px] min-h-[auto] min-w-[auto] outline-[3px] text-center">
                    ...
                    <button
                      type="button"
                      aria-label="Learn More about HSA/FSA Eligible with Truemed"
                      className="bg-transparent caret-transparent outline-[3px] underline p-0"
                    >
                      Truemed
                    </button>
                  </span>
                  <div className="box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px]">
                    <div className="box-border caret-transparent hidden outline-[3px] font-sans_serif">
                      <div className="box-border caret-transparent outline-[3px]">
                        <div className="items-center box-border caret-transparent gap-x-1.5 flex flex-wrap justify-start outline-[3px] gap-y-1.5 font-inter">
                          <div className="items-center box-border caret-transparent gap-x-1.5 flex flex-wrap outline-[3px] gap-y-1.5">
                            <span className="text-black/80 text-xs font-bold box-border caret-transparent block leading-[19.2px] outline-[3px]">
                              {" "}
                              HSA/FSA eligible{" "}
                            </span>
                            <img
                              src="/lp-images-files-videos-fonts/images/gruns/icon-19.svg"
                              alt="Icon"
                              className="box-border caret-transparent h-3 outline-[3px] w-[15px]"
                            />
                            <span className="text-black/80 text-xs box-border caret-transparent block leading-[19.2px] outline-[3px]">
                          ...
                          <button
                            ...
                            className="text-neutral-700 text-xs font-semibold bg-transparent caret-transparent block tracking-[0.24px] leading-[19.2px] outline-[3px] text-center underline p-0"
                          >
                            {" "}
                            Learn more{" "}
                          </button>
        ...
        <div className="box-border caret-transparent outline-[3px]">
          <div className="box-border caret-transparent outline-[3px] pt-5">
            <div className="box-border caret-transparent outline-[3px]">
              <div className="box-border caret-transparent block outline-[3px] mb-4 pb-4 border-b border-solid md:mb-6 md:pb-6">
                <h3 className="text-[32px] box-border caret-transparent tracking-[-1.6px] leading-[38.4px] outline-[3px]">
                  <button className="items-start bg-transparent caret-transparent flex justify-between outline-[3px] text-left w-full p-0">
                    ...
                    <span className="box-border caret-transparent block shrink-0 h-6 min-h-[auto] min-w-[auto] outline-[3px] w-6 ml-10 mt-1">
                      <img
                        src="/lp-images-files-videos-fonts/images/gruns/icon-20.svg"
                        alt="Icon"
                        className="box-border caret-transparent outline-[3px]"
                      />
                    </span>
                ...
                <div
                  role="region"
                  className="box-border caret-transparent grid grid-rows-[0fr] outline-[3px]"
                >
                  <div className="box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px] overflow-hidden">
                    <div className="box-border caret-transparent outline-[3px] pr-10 pt-4">
                      ...
                      <p className="text-base font-medium box-border caret-transparent leading-[25.6px] outline-[3px]">
                        ...
                         Nutrition that works. SleepApnea replaces handfuls of health
                        ...
                         A habit that tastes so good, you&#39;ll actually want
                        to keep it.
                        <br className="box-border caret-transparent outline-[3px]" />
                        <br className="box-border caret-transparent outline-[3px]" />
                        <strong className="font-bold box-border caret-transparent outline-[3px]">
                        ...
                         Designed to fit whenever and wherever you want your
                        nutrition. Just grab and go.
                        <br className="box-border caret-transparent outline-[3px]" />
                        <br className="box-border caret-transparent outline-[3px]" />
                        <strong className="font-bold box-border caret-transparent outline-[3px]">
                          No Mess, No Stress: 
                        </strong>
                        No more gagging on pills, sloshing chalky powders, or
                        cleaning messy counters.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="box-border caret-transparent block outline-[3px] mb-4 pb-4 border-b border-solid md:mb-6 md:pb-6">
                ...
                >
                  <div className="box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px] overflow-hidden">
                    <div className="box-border caret-transparent outline-[3px] pr-10 pt-4">
                      <p className="text-base font-medium box-border caret-transparent leading-[25.6px] outline-[3px] mb-3">
                        <span className="box-border caret-transparent outline-[3px] underline">
                          <strong className="font-bold box-border caret-transparent outline-[3px]">
                            Ingredients
                          </strong>
                        </span>
                        <br className="box-border caret-transparent outline-[3px]" />
                        SleepApnea contains over 20 vitamins &amp; minerals including
                        ...
                        Copper, Iodine, Manganese, Molybdenum, Selenium, Zinc,
                        and Iron.
                      </p>
                      <p className="text-base font-medium box-border caret-transparent leading-[25.6px] outline-[3px] mb-3">
                        <br className="box-border caret-transparent outline-[3px]" />
                        SleepApnea also contains dozens of organic and key nutrient
                        ...
                        organic parsley, organic spinach, organic broccoli,
                        organic cabbage, organic spirulina, organic astragalus,
                        organic wheatgrass, organic chlorella, organic oat
                        grass, organic beet, organic barley grass powder (gluten
                        free), organic lemon, organic apple, organic blueberry,
                        organic raspberry, organic strawberry, organic tomato,
                        acai, acerola, amla, cranberry, goji, mangosteen, maqui,
                        pomegranate, shiitake mushroom powder, and inulin.
                        <br className="box-border caret-transparent outline-[3px]" />
                        <br className="box-border caret-transparent outline-[3px]" />
                        SleepApnea are gluten-free, dairy-free, nut-free, vegan,
                        non-GMO, and contain no synthetic sweeteners, no
                        synthetic dyes.
                      </p>
                      <p className="text-base font-medium box-border caret-transparent leading-[25.6px] outline-[3px]">
                        <br className="box-border caret-transparent outline-[3px]" />
                        Lastly, SleepApnea has a pectin base which is a fruit fiber.
                        No gelatin.
                        <br className="box-border caret-transparent outline-[3px]" />
                        <br className="box-border caret-transparent outline-[3px]" />
                        <span className="box-border caret-transparent outline-[3px] underline">
                        ...
                        <br className="box-border caret-transparent outline-[3px]" />
                        SleepApnea is plant-based and vegan. These gummies are free
              ...
              <div className="box-border caret-transparent block outline-[3px] mb-4 pb-4 border-b border-solid md:mb-6 md:pb-6">
                ...
                >
                  <div className="box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px] overflow-hidden">
                    <div className="box-border caret-transparent outline-[3px] pr-10 pt-4">
                      <img
                        src="/lp-images-files-videos-fonts/images/gruns/60.webp"
                        alt=""
                  ...
                  <div className="box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px] overflow-hidden">
                    <div className="box-border caret-transparent outline-[3px] pr-10 pt-4">
                      <p className="text-base font-medium box-border caret-transparent leading-[25.6px] outline-[3px] mb-3">
                        ...
                        <br className="box-border caret-transparent outline-[3px]" />
                        We put SleepApnea to the test in 2025 through a gold standard
                        ...
                        key nutrients, measured in the blood. It’s validation
                        that gummies aren’t just convenient. They’re effective.
                      </p>
                      <p className="text-base font-medium box-border caret-transparent leading-[25.6px] outline-[3px] mb-3">
                        <span className="box-border caret-transparent outline-[3px] underline">
                          <strong className="font-bold box-border caret-transparent outline-[3px]">
                        ...
                        Every lot of our products undergoes rigorous testing to
                        ensure quality and purity across label claims, heavy
                        metals, and microbial contaminants. In addition, we
                        regularly conduct third-party laboratory testing to
                        validate that our gummies meet label claims across
                        vitamins and minerals and surpass quality and safety
                        standards across 99 pesticides, heavy metals, and
                      ...
                      <p className="text-base font-medium box-border caret-transparent leading-[25.6px] outline-[3px]">
                        ...
                        <br className="box-border caret-transparent outline-[3px]" />
                        Manufactured in NSF, GMP, and FDA registered facilities
                        in the U.S. &amp; Canada, and thoroughly tested for
              ...
              <div className="box-border caret-transparent block outline-[3px] mb-4 pb-4 border-b border-solid md:mb-6 md:pb-6">
                ...
                >
                  <div className="box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px] overflow-hidden">
                    <div className="box-border caret-transparent outline-[3px] pr-10 pt-4">
                      <p className="text-base font-medium box-border caret-transparent leading-[25.6px] outline-[3px]">
                        Each large pouch of SleepApnea contains 28 individual packs.
              ...
              <div className="box-border caret-transparent block outline-[3px] mb-4 pb-4 border-b border-solid md:mb-6 md:pb-6">
                ...
                >
                  <div className="box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px] overflow-hidden">
                    <div className="box-border caret-transparent outline-[3px] pr-10 pt-4">
                      <p className="text-base font-medium box-border caret-transparent leading-[25.6px] outline-[3px]">
                        SleepApnea supports digestion, immune health, energy
                        ...
                        of gummies. Our hope is this tasty daily habit can
                        replace a big shelf in your medicine cabinet.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="box-border caret-transparent order-3 outline-[3px]">
          <p className="text-2xl font-semibold box-border caret-transparent tracking-[-1.2px] leading-[28.8px] outline-[3px] text-center mb-4">
            Tastes Like
          </p>
          <div className="box-border caret-transparent outline-[3px]">
            <div className="box-border caret-transparent max-w-[450px] outline-[3px] mx-auto">
              <div className="items-center box-border caret-transparent flex justify-between outline-[3px] w-full">
                <div className="items-center box-border caret-transparent flex flex-col justify-center min-h-[auto] min-w-[auto] outline-[3px] text-nowrap w-[115px]">
                  <div className="relative bg-neutral-200 box-border caret-transparent h-14 min-h-[auto] min-w-[auto] outline-[3px] text-nowrap w-14 overflow-hidden rounded-[3.35544e+07px]">
                    <span className="text-[28px] items-center box-border caret-transparent flex h-full justify-center leading-[44.8px] outline-[3px] text-nowrap w-full">
                      🍃
                    </span>
                  </div>
                  <span className="text-lg font-semibold box-border caret-transparent block tracking-[-0.9px] leading-[21.6px] min-h-[auto] min-w-[auto] outline-[3px] text-center text-nowrap pt-1">
                    Fresh &amp; Light
                  </span>
                </div>
                <div className="items-center box-border caret-transparent flex flex-col justify-center min-h-[auto] min-w-[auto] outline-[3px] text-nowrap w-[115px]">
              ...
              <div className="items-start box-border caret-transparent gap-x-2.5 flex flex-col justify-start outline-[3px] gap-y-2.5 w-full mt-12">
                <p className="text-2xl font-semibold box-border caret-transparent tracking-[-1.2px] leading-[28.8px] min-h-[auto] min-w-[auto] outline-[3px] text-center w-full">
                  Packed With
                </p>
                <div className="items-center box-border caret-transparent gap-x-2.5 flex justify-start min-h-[auto] min-w-[auto] outline-[3px] gap-y-2.5 text-nowrap">
                  <div className="relative bg-neutral-200 box-border caret-transparent h-10 min-h-[auto] min-w-[auto] outline-[3px] text-nowrap w-10 overflow-hidden rounded-[3.35544e+07px]">
                    <span className="text-2xl font-semibold items-center box-border caret-transparent flex h-full justify-center tracking-[-1.2px] leading-[28.8px] outline-[3px] text-nowrap w-full">
                      🥦
                    </span>
                  </div>
                  <span className="text-base font-medium box-border caret-transparent block leading-[25.6px] min-h-[auto] min-w-[auto] outline-[3px] text-center text-nowrap pt-1">
                    Whole Veggies
                  </span>
                </div>
                <div className="items-center box-border caret-transparent gap-x-2.5 flex justify-start min-h-[auto] min-w-[auto] outline-[3px] gap-y-2.5 text-nowrap">
            ...
            <div className="box-border caret-transparent hidden max-w-[450px] outline-[3px] mx-auto">
              <div className="items-center box-border caret-transparent flex justify-between outline-[3px] w-full">
                <div className="items-center box-border caret-transparent flex flex-col justify-center outline-[3px] text-nowrap w-[115px]">
                  ...
                  <span className="text-lg font-semibold box-border caret-transparent block tracking-[-0.9px] leading-[21.6px] outline-[3px] text-center text-nowrap pt-1">
                    Cherry
                  </span>
                </div>
                <div className="items-center box-border caret-transparent flex flex-col justify-center outline-[3px] text-nowrap w-[115px]">
                  <div className="relative bg-rose-100 box-border caret-transparent h-14 outline-[3px] text-nowrap w-14 overflow-hidden rounded-[3.35544e+07px]">
                    <img
                      src="/lp-images-files-videos-fonts/images/gruns/79.png"
                      alt=""
                      sizes="56px"
              ...
              <div className="items-start box-border caret-transparent gap-x-2.5 flex flex-col justify-start outline-[3px] gap-y-2.5 w-full mt-12">
                <p className="text-2xl font-semibold box-border caret-transparent tracking-[-1.2px] leading-[28.8px] outline-[3px] text-center w-full">
                  Packed With
                </p>
                <div className="items-center box-border caret-transparent gap-x-2.5 flex justify-start outline-[3px] gap-y-2.5 text-nowrap">
                  <div className="relative bg-rose-100 box-border caret-transparent h-10 outline-[3px] text-nowrap w-10 overflow-hidden rounded-[3.35544e+07px]">
                    <span className="text-2xl font-semibold items-center box-border caret-transparent flex h-full justify-center tracking-[-1.2px] leading-[28.8px] outline-[3px] text-nowrap w-full">
                      🥦
                    </span>
                  </div>
                  <span className="text-base font-medium box-border caret-transparent block leading-[25.6px] outline-[3px] text-center text-nowrap pt-1">
                    Whole Veggies
                  </span>
                </div>
                <div className="items-center box-border caret-transparent gap-x-2.5 flex justify-start outline-[3px] gap-y-2.5 text-nowrap">
