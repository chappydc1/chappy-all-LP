export type SleepApneaProductGalleryImage = {
  src: string;
  alt: string;
...
export type SleepApneaProductGalleryThumbnail = {
  ariaLabel: string;
...
export type SleepApneaProductGalleryProps = {
  featuredWrapperClassName: string;
  slideWrapperClassName: string;
  thumbnailsWrapperClassName: string;
  thumbnailPictureClassName: string;
  images: SleepApneaProductGalleryImage[];
  thumbnails: SleepApneaProductGalleryThumbnail[];
  previousIconSrc: string;
  nextIconSrc: string;
};

export const SleepApneaProductGallery = (props: SleepApneaProductGalleryProps) => {
  return (
