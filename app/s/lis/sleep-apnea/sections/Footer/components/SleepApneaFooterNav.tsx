import { SleepApneaFooterNavColumn } from "./SleepApneaFooterNavColumn";

export const SleepApneaFooterNav = () => {
  return (
    <div
      role="navigation"
