export type SleepApneaFooterLegalProps = {
  variant: string;
};

export const SleepApneaFooterLegal = (props: SleepApneaFooterLegalProps) => {
  return (
    <div
