...
import { SleepApneaCartDrawer } from "./components/SleepApneaCartDrawer";
import { SleepApneaModals } from "./components/SleepApneaModals";
import { SleepApneaCookieConsent } from "./components/SleepApneaCookieConsent";

export default function SleepApneaLandingPage() {
  return (
    <>
      <SleepApneaAccessibilityWidgets
        variant="icon"
      ...
      <SleepApneaAccessibilityWidgets
        ...
        linkText=""
      />
      <SleepApneaAccessibilityWidgets variant="empty" src="" alt="" href="" linkText="" />
      <SleepApneaAccessibilityWidgets
        variant="default"
        src=""
        alt=""
        ...
        linkText=""
      />
      <SleepApneaHeroTopBar />
      <SleepApneaMainContent />
      ...
      <div className="box-border caret-transparent outline-[3px]"></div>
      <SleepApneaCartDrawer />
      <div className="box-border caret-transparent outline-[3px]"></div>
      <div className="box-border caret-transparent outline-[3px]"></div>
      <SleepApneaModals variant="default" />
      <SleepApneaModals variant="default" />
      <SleepApneaModals variant="truemed" />
      <iframe
