        ...
        <div className="box-border caret-transparent gap-x-4 flex flex-col outline-[3px] gap-y-4 pb-8 md:flex-row">
          ...
          <div className="box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px] w-full">
            ...
            <div className="box-border caret-transparent gap-x-4 flex flex-wrap outline-[3px] gap-y-4 mt-4">
              ...
              >
                <img
                  src="/lp-images-files-videos-fonts/images/gruns/3eipkmhbiaj24zspqwlt62chb007.jpg"
        ...
        <div className="box-border caret-transparent gap-x-4 flex flex-col outline-[3px] gap-y-4 pb-8 md:flex-row">
          ...
          <div className="box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px] w-full">
            ...
            <div className="box-border caret-transparent gap-x-4 flex flex-wrap outline-[3px] gap-y-4 mt-4">
              ...
              >
                <img
                  src="/lp-images-files-videos-fonts/images/gruns/rvq1wrg7bd8w9j6azndi67vaejub.jpg"
        ...
        <div className="box-border caret-transparent gap-x-4 flex flex-col outline-[3px] gap-y-4 pb-8 md:flex-row">
          ...
          <div className="box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px] w-full">
            ...
            <div className="box-border caret-transparent gap-x-4 flex flex-wrap outline-[3px] gap-y-4 mt-4">
              ...
              >
                <img
                  src="/lp-images-files-videos-fonts/images/gruns/66nk5glqrtyks9r9g8kzbw5xvsqq.jpg"
