export type CopdProductGalleryImage = {
  src: string;
  alt: string;
...
export type CopdProductGalleryThumbnail = {
  ariaLabel: string;
...
export type CopdProductGalleryProps = {
  featuredWrapperClassName: string;
  slideWrapperClassName: string;
  thumbnailsWrapperClassName: string;
  thumbnailPictureClassName: string;
  images: CopdProductGalleryImage[];
  thumbnails: CopdProductGalleryThumbnail[];
  previousIconSrc: string;
  nextIconSrc: string;
};

export const CopdProductGallery = (props: CopdProductGalleryProps) => {
  return (
