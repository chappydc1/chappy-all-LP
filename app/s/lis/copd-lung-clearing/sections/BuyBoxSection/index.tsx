import { CopdProductGallery } from "./components/CopdProductGallery";
import { CopdProductDetails } from "./components/CopdProductDetails";

export const CopdBuyBoxSection = () => {
  return (
                    ...
                    <CopdProductGallery
                      ...
                      images={[
                        ...
                        },
                        {
                          ...
                          alt: "What to expect taking Copd for the first 30 days",
                          wrapperClassName:
                            "box-border caret-transparent basis-full shrink-0 min-h-[auto] outline-[3px]",
                          pictureClassName:
                            "box-border caret-transparent outline-[3px]",
                        ...
                        },
                        {
                          ...
                          alt: "Copd Clinical study shows improvements in Vitamin C and Folate levels after 90 days",
                          wrapperClassName:
                            "box-border caret-transparent basis-full shrink-0 min-h-[auto] outline-[3px]",
                          pictureClassName:
                            "box-border caret-transparent outline-[3px]",
                        ...
                        },
                        {
                          ...
                          alt: "Copd Supports Digestion, Immunity, and Energy",
                          wrapperClassName:
                            "box-border caret-transparent basis-full shrink-0 min-h-[auto] outline-[3px]",
                          pictureClassName:
                            "box-border caret-transparent outline-[3px]",
