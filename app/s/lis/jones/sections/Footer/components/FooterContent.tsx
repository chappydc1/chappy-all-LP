import { JonesNewsletterSignup } from "../../Footer/components/NewsletterSignup";
import { JonesFooterColumn } from "../../Footer/components/FooterColumn";

export const JonesFooterContent = () => {
  return (
