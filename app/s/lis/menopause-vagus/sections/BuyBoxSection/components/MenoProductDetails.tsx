export const MenoProductDetails = () => {
  return (
                  ...
                  <div className="box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px] overflow-hidden">
                    <div className="box-border caret-transparent outline-[3px] pr-10 pt-4">
                      ...
                      <p className="text-base font-medium box-border caret-transparent leading-[25.6px] outline-[3px]">
                        ...
                         Nutrition that works. Meno replaces handfuls of health
                  ...
                  <div className="box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px] overflow-hidden">
                    <div className="box-border caret-transparent outline-[3px] pr-10 pt-4">
                      <p className="text-base font-medium box-border caret-transparent leading-[25.6px] outline-[3px] mb-3">
                        ...
                        <br className="box-border caret-transparent outline-[3px]" />
                        Meno contains over 20 vitamins &amp; minerals including
                      ...
                      <p className="text-base font-medium box-border caret-transparent leading-[25.6px] outline-[3px] mb-3">
                        <br className="box-border caret-transparent outline-[3px]" />
                        Meno also contains dozens of organic and key nutrient
                        ...
                        <br className="box-border caret-transparent outline-[3px]" />
                        <br className="box-border caret-transparent outline-[3px]" />
                        Meno are gluten-free, dairy-free, nut-free, vegan,
                        non-GMO, and contain no synthetic sweeteners, no
                        synthetic dyes.
                      </p>
                      <p className="text-base font-medium box-border caret-transparent leading-[25.6px] outline-[3px]">
                        <br className="box-border caret-transparent outline-[3px]" />
                        Lastly, Meno has a pectin base which is a fruit fiber.
                        No gelatin.
                        <br className="box-border caret-transparent outline-[3px]" />
                        <br className="box-border caret-transparent outline-[3px]" />
                        <span className="box-border caret-transparent outline-[3px] underline">
                        ...
                        <br className="box-border caret-transparent outline-[3px]" />
                        Meno is plant-based and vegan. These gummies are free
                  ...
                  <div className="box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px] overflow-hidden">
                    <div className="box-border caret-transparent outline-[3px] pr-10 pt-4">
                      <p className="text-base font-medium box-border caret-transparent leading-[25.6px] outline-[3px] mb-3">
                        ...
                        <br className="box-border caret-transparent outline-[3px]" />
                        We put Meno to the test in 2025 through a gold standard
              ...
              <div className="box-border caret-transparent block outline-[3px] mb-4 pb-4 border-b border-solid md:mb-6 md:pb-6">
                ...
                >
                  <div className="box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px] overflow-hidden">
                    <div className="box-border caret-transparent outline-[3px] pr-10 pt-4">
                      <p className="text-base font-medium box-border caret-transparent leading-[25.6px] outline-[3px]">
                        Each large pouch of Meno contains 28 individual packs.
              ...
              <div className="box-border caret-transparent block outline-[3px] mb-4 pb-4 border-b border-solid md:mb-6 md:pb-6">
                ...
                >
                  <div className="box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px] overflow-hidden">
                    <div className="box-border caret-transparent outline-[3px] pr-10 pt-4">
                      <p className="text-base font-medium box-border caret-transparent leading-[25.6px] outline-[3px]">
                        Meno supports digestion, immune health, energy
