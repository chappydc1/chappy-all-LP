export type MenoProductGalleryImage = {
  src: string;
  alt: string;
...
export type MenoProductGalleryThumbnail = {
  ariaLabel: string;
...
export type MenoProductGalleryProps = {
  featuredWrapperClassName: string;
  slideWrapperClassName: string;
  thumbnailsWrapperClassName: string;
  thumbnailPictureClassName: string;
  images: MenoProductGalleryImage[];
  thumbnails: MenoProductGalleryThumbnail[];
  previousIconSrc: string;
  nextIconSrc: string;
};

export const MenoProductGallery = (props: MenoProductGalleryProps) => {
  return (
