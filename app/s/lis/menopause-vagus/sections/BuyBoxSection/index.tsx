import { MenoProductGallery } from "./components/MenoProductGallery";
import { MenoProductDetails } from "./components/MenoProductDetails";

export const MenoBuyBoxSection = () => {
  return (
                    ...
                    <MenoProductGallery
                      ...
                      images={[
                        ...
                        },
                        {
                          ...
                          alt: "What to expect taking Meno for the first 30 days",
                          wrapperClassName:
                            "box-border caret-transparent basis-full shrink-0 min-h-[auto] outline-[3px]",
                          pictureClassName:
                            "box-border caret-transparent outline-[3px]",
                        ...
                        },
                        {
                          ...
                          alt: "Meno Clinical study shows improvements in Vitamin C and Folate levels after 90 days",
                          wrapperClassName:
                            "box-border caret-transparent basis-full shrink-0 min-h-[auto] outline-[3px]",
                          pictureClassName:
                            "box-border caret-transparent outline-[3px]",
                        ...
                        },
                        {
                          ...
                          alt: "Meno Supports Digestion, Immunity, and Energy",
                          wrapperClassName:
                            "box-border caret-transparent basis-full shrink-0 min-h-[auto] outline-[3px]",
                          pictureClassName:
                            "box-border caret-transparent outline-[3px]",
