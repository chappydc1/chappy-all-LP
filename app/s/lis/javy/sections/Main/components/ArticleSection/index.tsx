        ...
        <div className="box-border caret-transparent max-w-screen-md w-full mx-auto">
          <div className="box-border caret-transparent py-8 md:py-[46px]">
            <div className="box-border caret-transparent flex flex-col gap-y-12 md:gap-y-16">
              <JavyReasonCard
                videoPoster="/lp-images-files-videos-fonts/images/javy/1_rl7uzn.png"
              ...
              />
              <JavyReasonCard
                videoPoster="/lp-images-files-videos-fonts/images/javy/2_vwvosm.png"
              ...
              />
              <JavyReasonCard
                videoPoster="/lp-images-files-videos-fonts/images/javy/4_jwtjn5.png"
              ...
              />
              <JavyReasonCard
                videoPoster="/lp-images-files-videos-fonts/images/javy/4_omf53s.png"
              ...
              />
              <JavyReasonCard
                videoPoster="/lp-images-files-videos-fonts/images/javy/5_abhdr9.png"
              ...
              />
              <JavyReasonCard
                videoPoster="/lp-images-files-videos-fonts/images/javy/6_yeyl4s.png"
              ...
              />
              <JavyReasonCard
                videoPoster="/lp-images-files-videos-fonts/images/javy/7_tuexv2.png"
              ...
              />
              <JavyReasonCard
                videoPoster="/lp-images-files-videos-fonts/images/javy/8_p1pmld.png"
              ...
              />
              <JavyReasonCard
                videoPoster="/lp-images-files-videos-fonts/images/javy/9_zwohnt.png"
              ...
              />
              <JavyReasonCard
                videoPoster="/lp-images-files-videos-fonts/images/javy/10_rgnxtv.png"
